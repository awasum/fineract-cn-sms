...
import io.mifos.sms.api.v1.client.TemplateManager;
import io.mifos.sms.api.v1.domain.Sample;
import io.mifos.sms.service.TemplateConfiguration;
...
public class TestSample extends SuiteTestEnvironment {
  ...
  @EnableFeignClients(basePackages = {"io.mifos.sms.api.v1.client"})
  @RibbonClient(name = APP_NAME)
  @Import({TemplateConfiguration.class})
  @ComponentScan("io.mifos.sms.listener")
